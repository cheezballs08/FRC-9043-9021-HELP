...
import frc.robot.subsystems.drivetrain.enums.DriveType;
import frc.robot.subsystems.drivetrain.implementations.SimGyro;
import frc.robot.subsystems.drivetrain.implementations.SimModule;
...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    drivetrainSimulation = new SwerveDriveSimulation(DrivetrainConstants.DRIVETRAIN_CONFIG, RobotConstants.INITIAL_POSE);
    ...
    this.robotRelativeDriveCommand = new DriveCommand(
      ...
      () -> Math.abs(controller.getLeftX()) > ControllerConstants.DEADBAND ? controller.getLeftX() * -4 : 0,
      () -> Math.abs(controller.getLeftY()) > ControllerConstants.DEADBAND ? controller.getLeftY() * -4 : 0,
